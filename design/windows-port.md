...
> 상태: 확정 (2026-07-10) · **진행: Phase 0–4 완료 (2026-07-10)** — 1차 릴리즈 범위 구현 끝.
> Phase 1의 macOS 무변화 검증만 Mac 실행 대기(§10-영향 5). 다음: v* 태그 릴리즈(버전 결정: §9 Phase 4는 v2.0.0 제안), Phase 5 키우기 모드.
